...
GX_CONST GX_UBYTE display_1_GREENOFF_English[20] = "Toggle Green LED ON";
GX_CONST GX_UBYTE display_1_REDOFF_English[18] = "Toggle Red LED ON";
GX_CONST GX_UBYTE display_1_ORANGEOFF_English[21] = "Toggle Orange LED ON";
GX_CONST GX_UBYTE display_1_GREENON_English[21] = "Toggle Green LED OFF";
GX_CONST GX_UBYTE display_1_REDON_English[23] = "Toggle Green LED OFF\r";
GX_CONST GX_UBYTE display_1_ORANGEON_English[22] = "Toggle Orange LED OFF";
GX_CONST GX_UBYTE display_1_STRING_1_English[20] = "Toggle Green LED FF";

/* String Table for display_1 language English                                 */

GX_CONST GX_UBYTE *display_1_English_string_table[16] =
{
    GX_NULL,
    ...
    display_1_GREENOFF_English,
    display_1_REDOFF_English,
    display_1_ORANGEOFF_English,
    display_1_GREENON_English,
    display_1_REDON_English,
    display_1_ORANGEON_English,
