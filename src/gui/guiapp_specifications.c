...
/*  Date (dd.mm.yyyy):  4. 8.2017   Time (hh:mm): 17:35                        */
/*******************************************************************************/
...
{
    GX_STRING_ID_GREENON,                    /* string id                      */
    GX_FONT_ID_BUTTON,                       /* font id                        */
    GX_COLOR_ID_BTN_TEXT,                    /* normal text color              */
    GX_COLOR_ID_BTN_TEXT,                    /* selected text color            */
    GX_PIXELMAP_ID_CHECKBOX_ON,              /* unchecked pixelmap id          */
    GX_PIXELMAP_ID_CHECKBOX_OFF,             /* checked pixelmap id            */
...
GX_CHECKBOX_PROPERTIES window1_TOGGLEGREEN_properties =
{
    GX_STRING_ID_GREENON,                    /* string id                      */
    GX_FONT_ID_BUTTON,                       /* font id                        */
    GX_COLOR_ID_BTN_TEXT,                    /* normal text color              */
...
GX_CHECKBOX_PROPERTIES window1_TOGGLEORANGE_properties =
{
    GX_STRING_ID_ORANGEON,                   /* string id                      */
    GX_FONT_ID_BUTTON,                       /* font id                        */
    GX_COLOR_ID_BTN_TEXT,                    /* normal text color              */
    GX_COLOR_ID_BTN_TEXT,                    /* selected text color            */
    GX_PIXELMAP_ID_CHECKBOX_ON,              /* unchecked pixelmap id          */
...
GX_CONST GX_STUDIO_WIDGET window1_TOGGLEORANGE_define =
{
    "TOGGLEORANGE",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    ID_TOGGLEORANGE,                         /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {19, 85, 227, 112},                      /* widget size                    */
    GX_NULL,                                 /* no next widget                 */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_TOGGLEORANGE), /* control block    */
    (void *) &window1_TOGGLEORANGE_properties /* extended properties           */
};

GX_CONST GX_STUDIO_WIDGET window1_TOGGLEGREEN_define =
{
    "TOGGLEGREEN",
    GX_TYPE_CHECKBOX,                        /* widget type                    */
    ID_TOGGLEGREEN,                          /* widget id                      */
    #if defined(GX_WIDGET_USER_DATA)
    0,                                       /* user data                      */
    #endif
    GX_STYLE_BORDER_NONE|GX_STYLE_TRANSPARENT|GX_STYLE_ENABLED|GX_STYLE_BUTTON_TOGGLE|GX_STYLE_TEXT_LEFT,   /* style flags */
    ...
    GX_NULL,                                 /* drawing function override      */
    GX_NULL,                                 /* event function override        */
    {17, 17, 215, 46},                       /* widget size                    */
    &window1_TOGGLEORANGE_define,            /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
    offsetof(WINDOW1_CONTROL_BLOCK, window1_TOGGLEGREEN), /* control block     */
    (void *) &window1_TOGGLEGREEN_properties /* extended properties            */
};
...
GX_CONST GX_STUDIO_WIDGET window1_window1_text_define =
{
    ...
    GX_NULL,                                 /* event function override        */
    {80, 280, 159, 303},                     /* widget size                    */
    &window1_TOGGLEGREEN_define,             /* next widget definition         */
    GX_NULL,                                 /* no child widgets               */ 
