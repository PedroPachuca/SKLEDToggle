...
#if (false)
#ifdef __GNUC__
uint8_t g_display_fb_foreground[2][((800 * 480) * DISPLAY_BITS_PER_PIXEL_INPUT1) >> 3] __attribute__ ((aligned(64), section(".sdram")));
#else /* __ICCARM__ */
#pragma data_alignment = 64
#pragma location = ".sdram"
uint8_t g_display_fb_foreground[2][((800 * 480) * DISPLAY_BITS_PER_PIXEL_INPUT1) >> 3];
#endif
#else
